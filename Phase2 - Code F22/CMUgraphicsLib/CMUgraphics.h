...
class window {
  ...
  public:
      void DrawHexagon(const int iX1, const int iY1, const int iX2, const int iY2,
          const int iX3, const int iY3, const int iX4, const int iY4, const int iX5, const int
          iY5, const int iX6, const int iY6, const drawstyle dsStyle);    // Create a new window! iWindWidth and iWindHeight will change the size of 
